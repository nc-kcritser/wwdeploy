...
📦 /root/
This directory is used as a holding area for the large software packages (ISOs, tarballs, runfiles) that the scripts will install. The scripts are designed to look for these files in /root/ by default.
