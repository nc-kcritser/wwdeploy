...
sms_name=warewulf-hn                                 # Hostname for SMS server 
...
sms_eth_internal=ens19                           # Internal Ethernet interface on SMS
...
sms_external_ip=172.18.10.124       # External network information
external_netmask=255.255.255.0      # Subnet netmask for external network
external_cidr=24                    # CIDR for external network
external_gateway=172.18.10.1        # Gateway for external network
